...
function buildKeys() {
  ...
  const keys = [
    ...
    ['fw/fn1', 'ƒ1', ['FUNCTION1', '#:layerShift( 1 )', 'FUN1', 'FUN'], c.spec],
    ['fw/fn2', 'ƒ2', ['FUNCTION2', '#:layerShift( 2 )', 'FUN2'], c.spec],
    ['fw/fn3', 'ƒ3', ['FUNCTION3', '#:layerShift( 3 )', 'FUN3'], c.spec],
    ['fw/fn4', 'ƒ4', ['FUNCTION4', '#:layerShift( 4 )', 'FUN4'], c.spec],
    ['fw/fn5', 'ƒ5', ['FUNCTION5', '#:layerShift( 5 )', 'FUN5'], c.spec],
    ['fw/fn6', 'ƒ6', ['FUNCTION6', '#:layerShift( 6 )', 'FUN6'], c.spec],
    ['fw/fn7', 'ƒ7', ['FUNCTION7', '#:layerShift( 7 )', 'FUN7'], c.spec],
    ['fw/fn8', 'ƒ8', ['FUNCTION8', '#:layerShift( 8 )', 'FUN8']],
    ['fw/fn9', 'ƒ9', ['FUNCTION9', '#:layerShift( 9 )', 'FUN9']],
    ['fw/fn10', 'ƒ10', ['FUNCTION10', '#:layerShift( 10 )', 'FUN10']],
    ['fw/fn11', 'ƒ11', ['FUNCTION11', '#:layerShift( 11 )', 'FUN11']],
    ['fw/fn12', 'ƒ12', ['FUNCTION12', '#:layerShift( 12 )', 'FUN12']],
    ['fw/fn13', 'ƒ13', ['FUNCTION13', '#:layerShift( 13 )', 'FUN13']],
    ['fw/fn14', 'ƒ14', ['FUNCTION14', '#:layerShift( 14 )', 'FUN14']],
    ['fw/fn15', 'ƒ15', ['FUNCTION15', '#:layerShift( 15 )', 'FUN15']],
    ['fw/fn16', 'ƒ16', ['FUNCTION16', '#:layerShift( 16 )', 'FUN16']],

    ['fw/lck1', 'LOCK-1', ['LOCK1', '#:layerLock( 1 )', 'LCK1', 'LCK'], c.spec],
    ['fw/lck2', 'LOCK-2', ['LOCK2', '#:layerLock( 2 )', 'LCK2'], c.spec],
    ['fw/lck3', 'LOCK-3', ['LOCK3', '#:layerLock( 3 )', 'LCK3'], c.spec],
    ['fw/lck4', 'LOCK-4', ['LOCK4', '#:layerLock( 4 )', 'LCK4'], c.spec],
    ['fw/lck5', 'LOCK-5', ['LOCK5', '#:layerLock( 5 )', 'LCK5'], c.spec],
    ['fw/lck6', 'LOCK-6', ['LOCK6', '#:layerLock( 6 )', 'LCK6'], c.spec],
    ['fw/lck7', 'LOCK-7', ['LOCK7', '#:layerLock( 7 )', 'LCK7'], c.spec],
    ['fw/lck8', 'LOCK-8', ['LOCK8', '#:layerLock( 8 )', 'LCK8']],
    ['fw/lck9', 'LOCK-9', ['LOCK9', '#:layerLock( 9 )', 'LCK9']],
    ['fw/lck10', 'LOCK-10', ['LOCK10', '#:layerLock( 10 )', 'LCK10']],
    ['fw/lck11', 'LOCK-11', ['LOCK11', '#:layerLock( 11 )', 'LCK11']],
    ['fw/lck12', 'LOCK-12', ['LOCK12', '#:layerLock( 12 )', 'LCK12']],
    ['fw/lck13', 'LOCK-13', ['LOCK13', '#:layerLock( 13 )', 'LCK13']],
    ['fw/lck14', 'LOCK-14', ['LOCK14', '#:layerLock( 14 )', 'LCK14']],
    ['fw/lck15', 'LOCK-15', ['LOCK15', '#:layerLock( 15 )', 'LCK15']],
    ['fw/lck16', 'LOCK-16', ['LOCK16', '#:layerLock( 16 )', 'LCK16']],

    ['fw/lat1', 'LATCH-1', ['LATCH1', '#:layerLatch( 1 )', 'LAT1', 'LAT'], c.spec, { fontSize: 12 }],
    ['fw/lat2', 'LATCH-2', ['LATCH2', '#:layerLatch( 2 )', 'LAT2'], c.spec, { fontSize: 12 }],
    ['fw/lat3', 'LATCH-3', ['LATCH3', '#:layerLatch( 3 )', 'LAT3'], c.spec, { fontSize: 12 }],
    ['fw/lat4', 'LATCH-4', ['LATCH4', '#:layerLatch( 4 )', 'LAT4'], c.spec, { fontSize: 12 }],
    ['fw/lat5', 'LATCH-5', ['LATCH5', '#:layerLatch( 5 )', 'LAT5'], c.spec, { fontSize: 12 }],
    ['fw/lat6', 'LATCH-6', ['LATCH6', '#:layerLatch( 6 )', 'LAT6'], c.spec, { fontSize: 12 }],
    ['fw/lat7', 'LATCH-7', ['LATCH7', '#:layerLatch( 7 )', 'LAT7'], c.spec, { fontSize: 12 }],
    ['fw/lat8', 'LATCH-8', ['LATCH8', '#:layerLatch( 8 )', 'LAT8']],
    ['fw/lat9', 'LATCH-9', ['LATCH9', '#:layerLatch( 9 )', 'LAT9']],
    ['fw/lat10', 'LATCH-10', ['LATCH10', '#:layerLatch( 11 )', 'LAT10']],
    ['fw/lat11', 'LATCH-11', ['LATCH11', '#:layerLatch( 11 )', 'LAT11']],
    ['fw/lat12', 'LATCH-12', ['LATCH12', '#:layerLatch( 12 )', 'LAT12']],
    ['fw/lat13', 'LATCH-13', ['LATCH13', '#:layerLatch( 13 )', 'LAT13']],
    ['fw/lat14', 'LATCH-14', ['LATCH14', '#:layerLatch( 14 )', 'LAT14']],
    ['fw/lat15', 'LATCH-15', ['LATCH15', '#:layerLatch( 15 )', 'LAT15']],
    ['fw/lat16', 'LATCH-16', ['LATCH16', '#:layerLatch( 16 )', 'LAT16']],
