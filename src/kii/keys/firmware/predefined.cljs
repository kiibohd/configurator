...
(defonce all
  [[:a "A" nil :core]
   ...
   [:i11n/lang2 "英数/한자" ["LANG2" "HANJA" "EISU" "英数/한자"] :i11l]
   [:i11n/lang3 "カタカナ" ["LANG3" "KATAKANA" "カタカナ"] :i11l]
   [:i11n/lang4 "ひらがな" ["LANG4" "HIRAGANA" "ひらがな"] :i11l]
   [:i11n/lang5 "半角/全角" ["LANG5" "ZENKAKUHANKAKU" "ZENKAKU HANKAKU" "半角/全角"] :i11l]
