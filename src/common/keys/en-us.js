...
function buildCode2iec() {
  ...
  //@ts-ignore
  return mapping.reduce((arr, [code, loc]) => {
    arr[code] = loc;
    return arr;
  }, []);
}
...
/**
 * @typedef {Object<string, string>} LocalizedKey
 * @property {string} iec
 * @property {string} key
...
/**
 * @typedef {Object<string, any>} Locale
 * @property {LocalizedKey[]} keys
 * @property {Object<number, string>} code2iec
 * @property {_.Dictionary<LocalizedKey>} iec2key
 * @property {_.Dictionary<LocalizedKey>} keyname2key
 */
