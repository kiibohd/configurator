...
declare namespace chroma {
    ...
    export type InterpolationMode = "rgb" | "hsl" | "hsv" | "hsi" | "lab" | "lch" | "hcl" | "lrgb";
    ...
    export interface ChromaStatic {
         ...
         */
        (color: string | number | { r: string | number; g: string | number; b: string | number}): Color;
...
declare module 'chroma-js' {
    const chroma: chroma.ChromaStatic;
