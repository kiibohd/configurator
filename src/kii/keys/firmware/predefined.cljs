...
(defonce all
  [[:a "A" nil :core]
   ...
   [:mult/volup "VOL+" ["CONS:VOLUME UP" "CONS:VOLUMEUP"] :mult]
   [:mult/voldn "VOL-" ["CONS:VOLUME DOWN" "CONS:VOLUMEDOWN"] :mult]
   [:mult/plps "PL/PS" ["CONS:PAUSE PLAY" "CONS:PAUSEPLAY"] :mult]
   [:mult/play "PLAY" ["CONS:PLAY"] :mult]
   [:mult/pause "PAUSE" ["CONS:PAUSE"] :mult]
   [:mult/ff "FF" ["CONS:FAST FORWARD" "CONS:FASTFORWARD"] :mult]
   [:mult/rew "RW" ["CONS:REWIND"] :mult]
   [:mult/next "NEXT" ["CONS:SCAN NEXT TRACK" "CONS:SCANNEXTTRACK"] :mult]
   [:mult/prev "PREV" ["CONS:SCAN PREVIOUS TRACK" "CONS:SCANPREVIOUSTRACK"] :mult]
   [:mult/stop "STOP" ["CONS:STOP"] :mult]
   [:mult/eject "EJECT" ["CONS:EJECT"] :mult]
   [:mult/calc "CALC" ["CONS:CALCULATOR"] :mult]
   [:mult/web "WEB" ["CONS:INTERNET BROWSER" "CONS:INTERNETBROWSER"] :mult]
   [:mult/files "FILES" ["CONS:FILE BROWSER" "CONS:FILEBROWSER"] :mult]
   [:mult/scrup "SCRN+" ["CONS:BRIGHTNESS INCREMENT" "CONS:BRIGHTNESSINCREMENT"] :mult]
   [:mult/scrdn "SCRN-" ["CONS:BRIGHTNESS DECREMENT" "CONS:BRIGHTNESSDECREMENT"] :mult]
   [:mult/power "POWER" ["SYS:POWER DOWN" "SYS:POWERDOWN"] :mult]
   [:mult/sleep "SLEEP" ["SYS:SLEEP"] :mult]
   [:mult/wake "WAKEUP" ["SYS:WAKE UP" "SYS:WAKEUP"] :mult]
   ;; other stuff...
   ])
