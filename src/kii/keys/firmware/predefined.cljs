...
(defonce all
  [[:a "A" nil :core]
   ...
   [:lat1 "LATCH-1" ["LAT1" "LATCH1" "LAT"] :spec {:font-size "12px"}]
   [:lat2 "LATCH-2" ["LAT2" "LATCH2"] :spec {:font-size "12px"}]
   [:lat3 "LATCH-3" ["LAT3" "LATCH3"] :spec {:font-size "12px"}]
   [:lat4 "LATCH-4" ["LAT4" "LATCH4"] :spec {:font-size "12px"}]
   [:lat5 "LATCH-5" ["LAT5" "LATCH5"] :spec {:font-size "12px"}]
   [:lat6 "LATCH-6" ["LAT6" "LATCH6"] :spec {:font-size "12px"}]
   [:lat7 "LATCH-7" ["LAT7" "LATCH7"] :spec {:font-size "12px"}]
